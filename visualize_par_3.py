...
solution_simulee_0 = np.genfromtxt("sorties/3process_solution_sortie0.txt", delimiter=';')
solution_simulee_0 = solution_simulee_0[:,0:-2]
solution_simulee_1 = np.genfromtxt("sorties/3process_solution_sortie1.txt", delimiter=';')
solution_simulee_1 = solution_simulee_1[:,2:]
solution_simulee_2 = np.genfromtxt("sorties/3process_solution_sortie2.txt", delimiter=';')
solution_simulee_2 = solution_simulee_2[:,2:]

solution_simulee = np.hstack((solution_simulee_0,solution_simulee_1,solution_simulee_2))
