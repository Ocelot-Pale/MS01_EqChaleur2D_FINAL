...
solution_simulee_0 = np.genfromtxt("sorties/4process_solution_sortie0.txt", delimiter=';')
solution_simulee_0 = solution_simulee_0[:,0:-2]
solution_simulee_1 = np.genfromtxt("sorties/4process_solution_sortie1.txt", delimiter=';')
solution_simulee_1 = solution_simulee_1[:,2:]
solution_simulee_2 = np.genfromtxt("sorties/4process_solution_sortie2.txt", delimiter=';')
solution_simulee_2 = solution_simulee_2[:,2:]
solution_simulee_3 = np.genfromtxt("sorties/4process_solution_sortie3.txt", delimiter=';')
...
contour1 = axs[0].contourf(X, Y,  solution_simulee,np.linspace(-1,1,50) , cmap='magma', vmin=vmin, vmax=vmax)
axs[0].set_xlim(0, 1)
axs[0].set_ylim(0, 1)
axs[0].set_title("Solution Simulee")
fig.colorbar(contour1, ax=axs[0])

contour2 = axs[1].contourf(X, Y, solution_exacte,np.linspace(-1,1,50) , cmap='magma', vmin=vmin, vmax=vmax)
axs[1].set_xlim(0, 1)
axs[1].set_ylim(0, 1)
